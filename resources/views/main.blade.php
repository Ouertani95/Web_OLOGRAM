                ...
                <form action='/' method='POST' enctype="multipart/form-data" id="uploadForm">
                    ...
                    <div class="row no-gutters text-center">
                      <div class="col-sm-8 text-center">
                        <div class="accordion" id="case1-accordion-advanced">
                          <div class="accordion-item justify-content-center text-center">
                            <h2 class="accordion-header justify-content-center text-center" id="heading1-advanced">
                      ...
                      <div class="col text-center mt-1">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg" data-title="Submit button" data-intro="Once you finished adding your files and options you can click this button to submit.">Start job</button></br><br>
            ...
            <form action='/' method='POST' enctype="multipart/form-data" id="uploadForm2">
                ...
                <div class="row no-gutters text-center">
                  ...
                  <div class="col-sm-4 text-center">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg mt-1" data-title="Submit button" data-intro="Once you finished adding your files and options you can click this button to submit.">Start job</button></br><br>
            ...
            <form action='/' method='POST' enctype="multipart/form-data" id="uploadForm3">
                ...
                <div class="row no-gutters text-center">
                  ...
                  <div class="col-sm-4 text-center">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg mt-1">Start job</button></br><br>
