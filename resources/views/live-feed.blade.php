  ...
  <nav class="navbar navbar-dark fixed-top bg-dark navbar-expand-sm">
    ...
    <div class="container mb-5 mt-5 pt-3">
      <div class="row justify-content-md-center">
        <div class="col-sm-8 text-start text-center">
          ...
          @if (\Session::has('success'))
            <div class="alert alert-success">
              <h4 id="success_field"> <strong>Your results are ready !</strong> </h4>
              <br>
          ...
          @elseif (\Session::has('queue'))
            <div class="alert alert-primary alert-block">
              <div id="queue_field"> <strong> {!! \Session::get('queue') !!}</strong></div>
            </div>
                    ...
                    <div class="accordion-item justify-content-md-center">
                        ...
                        <div id="collapse2" class="accordion-collapse collapse show" aria-labelledby="heading2" data-bs-parent="#accordion2">
                            <div class="accordion-body text-center border border-dark rounded-3">
                                ...
                                @if (\Session::has('download_gtf'))
                                <a class="btn btn-success mb-3" href="{!! \Session::get('download_gtf') !!}" role="button">
                                ...
                                @elseif (\Session::has('download_chr'))
                                <a class="btn btn-success mb-3" href="{!! \Session::get('download_chr') !!}" role="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"></path>
                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"></path>
                                    </svg>
                                    Download Ensembl CHR
                                </a>

                                @elseif (\Session::has('download_gtf_chr'))
                                <a class="btn btn-success mb-3" href="{!! \Session::get('download_gtf_chr') !!}" role="button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                    <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"></path>
                                    <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"></path>
                                    </svg>
        ...
        <div class="row justify-content-md-center">
            <div class="col-sm-8 text-start justify-content-md-center ">
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item justify-content-md-center">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body text-break text-center border border-dark rounded-3 justify-content-center">

                              @if (\Session::has('success'))
                                <a class="btn btn-success mb-3 text-center" href={{ $log }} role="button">
                                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
                                      <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"></path>
                                      <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"></path>
                                      </svg>
