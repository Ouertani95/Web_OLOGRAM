...
<body>
    ...
    <div class="container mt-2">
        ...
        <nav>
            <div class="nav nav-pills nav-filled p-3" id="nav-tab" role="tab-list">
                <button class="nav-link active" id="nav-BED-GTF-tab" data-bs-toggle="tab" data-bs-target="#case1" type="button" role="tab" aria-controls="case1" aria-selected="true">BED vs GTF</button>
                <button class="nav-link" id="nav-BED-GTF-keys-tab" data-bs-toggle="tab" data-bs-target="#case2" type="button" role="tab" aria-controls="case2" aria-selected="true">BED vs GTF (keys)</button>
                <button class="nav-link" id="nav-BED-BED-tab" data-bs-toggle="tab" data-bs-target="#case3" type="button" role="tab" aria-controls="case3" aria-selected="true">BED vs BEd</button>
                <button class="nav-link" id="nav-BED-BED-combo-tab" data-bs-toggle="tab" data-bs-target="#case4" type="button" role="tab" aria-controls="case4" aria-selected="true">BED vs BED (combinations)</button>
            </div>
        </nav>
        ...
        <div class="tab-content" id="nav-tabContent1">
            ...
            <div class="tab-pane border border-primary rounded-3 fade show active p-3 " id="case1" role="tabpanel" aria-labelledby="nav-BED-GTF-tab">
                <div>
