...
<body>
    ...
    <div class="container mt-2">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item" ><a class="nav-link active" data-bs-toggle="tab" href="#case1">BED vs GTF</a></li>
            <li class="nav-item" ><a class="nav-link" data-bs-toggle="tab" href="#case2">BED vs GTF(keys)</a></li>
            <li class="nav-item" ><a class="nav-link" data-bs-toggle="tab" href="#case3">BED vs BED </a></li>
            <li class="nav-item" ><a class="nav-link" data-bs-toggle="tab" href="#case4">BED vs BED (combinations) </a></li>
        </ul>
